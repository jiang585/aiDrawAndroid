...
本系统调用https://ai.t8star.cn 提供的gpt image2接口
...
- 兼容上游返回纯 Base64、data URL、重复 data 前缀的图片结果

## 图生图说明

Dalle 兼容文档里，Generations 的 `image` 字段是 `string[]`，并注明传递文件链接；Edits 才是文件流。当前 1.01 的策略是：
